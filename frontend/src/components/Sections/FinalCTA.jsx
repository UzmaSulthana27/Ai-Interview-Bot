...
const FinalCTA = ({ onStartTrial }) => {
  return (
    <section className="px-4 md:px-8 py-24 relative z-10">
      <motion.div 
        className="max-w-7xl mx-auto rounded-[3rem] bg-[#0a1128] border border-white/5 p-10 md:p-16 lg:p-20 text-left text-white overflow-hidden relative shadow-2xl shadow-indigo-950/50"
          ...
          <div className="lg:max-w-2xl">
            ...
            >
              <h2 className="font-headline text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
                Ready to secure your <span className="text-indigo-200">dream role?</span>
              </h2>
            ...
            >
              <motion.button 
                ...
                className="bg-white text-indigo-700 px-10 py-5 rounded-2xl font-headline font-bold text-lg shadow-xl shadow-black/10 flex items-center justify-center gap-2"
              ...
              <motion.button 
                className="bg-indigo-500/20 backdrop-blur-md border border-white/20 text-white px-10 py-5 rounded-2xl font-headline font-bold text-lg"
                whileHover={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', scale: 1.05, y: -4 }}
                whileTap={{ scale: 0.98 }}
              >
                Talk to an Expert
              </motion.button>
