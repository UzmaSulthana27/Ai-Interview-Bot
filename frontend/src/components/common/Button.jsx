...
const Button = ({ 
  ...
  const variants = {
    primary: isDark 
      ...
      : "bg-primary text-[#f5f5f0] hover:bg-primary/20 shadow-[0px_20px_40px_rgba(45,90,39,0.15)]",
    secondary: isDark
      ? "bg-[#000000] text-[#00ffa3] border border-[#004d38] hover:bg-[#00ffa3] hover:text-[#000000]"
      : "bg-[#e8f0e0] text-white hover:bg-[#d0e8d0]",
    outline: isDark
      ...
      : "bg-white border-0.5px border-[#2d5a27] text-primary hover:bg-[#f0f5ec]",
    gradient: isDark
      ? "bg-[#00ffa3] text-[#000000] shadow-[0_0_16px_rgba(0,255,163,0.4)] hover:shadow-[0_0_28px_rgba(0,255,163,0.7)] hover:-translate-y-[1px]"
